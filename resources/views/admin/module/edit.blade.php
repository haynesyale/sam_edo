...
@section('content')
    ...
    <div class="panel panel-default">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="active"><a href="/admin/module/create">修改模块</a></li>
        </ul>
        <div class="panel-body">
            <form action="/admin/module/{{$data['id']}}" method="post" class="form-horizontal" role="form">
                {{csrf_field()}}
                {{method_field('PUT')}}
                ...
                <div class="form-group">
                    <div class="col-sm-8" style="margin-left: 182px">
                        <div class="input-group" style="margin-top:5px;">
                            <img src="{{$data['preview']}}" class="img-responsive img-thumbnail" width="150">
